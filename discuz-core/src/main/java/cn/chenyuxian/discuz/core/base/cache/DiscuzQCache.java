...
import cn.chenyuxian.discuz.core.common.cache.DiscuzQCacheKey;
...
public class DiscuzQCache<T> {
	...
	@Autowired
	public DiscuzQCache(RedisTemplate<String, T> redisTemplate) {
		super();
	...
	public void delListCache() {
		String[] keys = {
				DiscuzQCacheKey.CATEGORIES,
				DiscuzQCacheKey.LIST_THREADS_V3_CREATE_TIME,
				DiscuzQCacheKey.LIST_THREADS_V3_SEQUENCE,
				DiscuzQCacheKey.LIST_THREADS_V3_VIEW_COUNT,
				DiscuzQCacheKey.LIST_THREADS_V3_POST_TIME,
				DiscuzQCacheKey.LIST_THREADS_V3_COMPLEX,
				DiscuzQCacheKey.LIST_THREADS_V3_ATTENTION
		};
		delKeys(keys);
	}
}
