...
@Data
@Component
@ConfigurationProperties(prefix = "discuz")
public class DiscuzProperties {
    ...
    private DiscuzInterceptorProperties interceptor;

    /**
     * 过滤器配置
     */
    @NestedConfigurationProperty
    private DiscuzFilterProperties filter;
     ...
     */
    @NestedConfigurationProperty
    private DiscuzCorsProperties cors = new DiscuzCorsProperties();
